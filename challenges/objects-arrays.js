...
const universitiesUnsorted = [];
graduates.forEach((graduate)=>{universitiesUnsorted.push(graduate.university)});
universities = universitiesUnsorted.sort()
...
const uni = universities.filter(str => str.includes('Uni') || str.includes('uni'));
console.log(uni);
...
const names = [];
zooAnimals.forEach(animal => names.push(animal.animal_name));
console.log(names);
